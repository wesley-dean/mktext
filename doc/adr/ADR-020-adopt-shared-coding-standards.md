# ADR-020: Adopt Shared Coding Standards
...
`mktext` already has repository-specific governance in its README, agent
...
Existing accepted ADRs remain authoritative for `mktext` architecture, public
